...
rules_Palestine =
    ...
    , Rule 2022 maxYear Oct (Prev Sat 30) 120 WallClock 0
    , Rule 2023 maxYear Mar (Prev Sat 30) 120 WallClock 60
    ]
...
{-| `Europe/Kyiv`
-}
europe__kyiv : () -> Time2.Zone
europe__kyiv _ =
    fromSpecification "Europe/Kyiv" <|
        Zone
